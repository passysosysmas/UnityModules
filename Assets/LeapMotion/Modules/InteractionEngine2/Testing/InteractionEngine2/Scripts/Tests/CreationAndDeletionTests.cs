...
namespace Leap.Unity.Interaction2.Tests {
  ...
  public class CreationAndDeletionTests : InteractionEngine2TestBase {
    ...
    [UnityTest]
    public IEnumerator CanCreateInteractionObject2AtRuntime() {
      yield return wait(beginningTestWait);
      ...
      newBox.AddComponent<InteractionObject2>();
